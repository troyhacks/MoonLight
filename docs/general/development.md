...
* [MoonLight Modules](https://moonmodules.org/MoonLight/moonbase/modules/) e.g. Light Control, Editor, Artnet, Info, Channel View. They are subclasses of Modules.h/cpp and implement setupDefinition, onUpdate and optional loop. New modules need to be defined in main.cpp and added to menu.svelte. All further UI is generated by Module.svelte.
