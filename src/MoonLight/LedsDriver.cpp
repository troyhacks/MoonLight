  ...
  void LedsDriver::init(Lights &lights, const std::vector<SortedPin> &sortedPins) {
    for (const SortedPin &sortedPin : sortedPins) {
      ...
      switch (sortedPin.pin) {
        ...
        case 0: FastLED.addLeds<ML_CHIPSET, 0>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 1: FastLED.addLeds<ML_CHIPSET, 1>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 2: FastLED.addLeds<ML_CHIPSET, 2>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 3: FastLED.addLeds<ML_CHIPSET, 3>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 4: FastLED.addLeds<ML_CHIPSET, 4>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 5: FastLED.addLeds<ML_CHIPSET, 5>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 6: FastLED.addLeds<ML_CHIPSET, 6>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 7: FastLED.addLeds<ML_CHIPSET, 7>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 8: FastLED.addLeds<ML_CHIPSET, 8>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 9: FastLED.addLeds<ML_CHIPSET, 9>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 10: FastLED.addLeds<ML_CHIPSET, 10>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 11: FastLED.addLeds<ML_CHIPSET, 11>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 12: FastLED.addLeds<ML_CHIPSET, 12>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 13: FastLED.addLeds<ML_CHIPSET, 13>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 14: FastLED.addLeds<ML_CHIPSET, 14>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 15: FastLED.addLeds<ML_CHIPSET, 15>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
    #if !defined(BOARD_HAS_PSRAM) && !defined(ARDUINO_ESP32_PICO)
        // 16+17 = reserved for PSRAM, or reserved for FLASH on pico-D4
        case 16: FastLED.addLeds<ML_CHIPSET, 16>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 17: FastLED.addLeds<ML_CHIPSET, 17>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
    #endif
        case 18: FastLED.addLeds<ML_CHIPSET, 18>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 19: FastLED.addLeds<ML_CHIPSET, 19>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 20: FastLED.addLeds<ML_CHIPSET, 20>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 21: FastLED.addLeds<ML_CHIPSET, 21>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 22: FastLED.addLeds<ML_CHIPSET, 22>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 23: FastLED.addLeds<ML_CHIPSET, 23>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 24: FastLED.addLeds<ML_CHIPSET, 24>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 25: FastLED.addLeds<ML_CHIPSET, 25>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 26: FastLED.addLeds<ML_CHIPSET, 26>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 27: FastLED.addLeds<ML_CHIPSET, 27>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 28: FastLED.addLeds<ML_CHIPSET, 28>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 29: FastLED.addLeds<ML_CHIPSET, 29>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 30: FastLED.addLeds<ML_CHIPSET, 30>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 31: FastLED.addLeds<ML_CHIPSET, 31>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 32: FastLED.addLeds<ML_CHIPSET, 32>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 33: FastLED.addLeds<ML_CHIPSET, 33>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // 34-39 input-only
        // case 34: FastLED.addLeds<ML_CHIPSET, 34>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 35: FastLED.addLeds<ML_CHIPSET, 35>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 36: FastLED.addLeds<ML_CHIPSET, 36>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 37: FastLED.addLeds<ML_CHIPSET, 37>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 38: FastLED.addLeds<ML_CHIPSET, 38>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // case 39: FastLED.addLeds<ML_CHIPSET, 39>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        ...
        case 38: FastLED.addLeds<ML_CHIPSET, 38>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 39: FastLED.addLeds<ML_CHIPSET, 39>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 40: FastLED.addLeds<ML_CHIPSET, 40>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 41: FastLED.addLeds<ML_CHIPSET, 41>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 42: FastLED.addLeds<ML_CHIPSET, 42>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 43: FastLED.addLeds<ML_CHIPSET, 43>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 44: FastLED.addLeds<ML_CHIPSET, 44>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 45: FastLED.addLeds<ML_CHIPSET, 45>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        // 46 input-only
        // case 46: FastLED.addLeds<ML_CHIPSET, 46>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        ...
        case 45: FastLED.addLeds<ML_CHIPSET, 45>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 46: FastLED.addLeds<ML_CHIPSET, 46>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 47: FastLED.addLeds<ML_CHIPSET, 47>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
        case 48: FastLED.addLeds<ML_CHIPSET, 48>(lights.leds, startLed, nrOfLights).setCorrection(TypicalLEDStrip); break;
